...
class Customer(models.Model):
    #customer_id = models.IntegerField(null=False, unique=True)
...
class Review(models.Model):
    review_id = models.CharField(max_length=12,null=False, unique=True)
...
class Genre(models.Model):
    ...
    allbook=models.ManyToManyField(Book)

    #allbook = models.ForeignKey('Book',on_delete=models.CASCADE, )
    def __str__(self):
        return self.type 